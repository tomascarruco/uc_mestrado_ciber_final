...
setup ()
{
    ...
    Serial.begin (); // USB CDC doesn't need baud rate
#else
    Serial.begin (115200);
#endif
    while (!Serial) {
    ...
    Serial.write ("=== AES128 Encryption/Decryption Benchmark ===");
    Serial.write ("SAMD21 Cortex-M0+ @ 48MHz");
    Serial.write ("Free SRAM at start: ");
    Serial.write (freeMemory ());
    Serial.write (" b");
    Serial.write ("Static buffer allocation: ");
    Serial.write (MAX_PAYLOAD + MAX_ENCRYPTED + MAX_ENCRYPTED);
    Serial.write (" b");
    Serial.write ("\n");
    Serial.write ("Starting benchmark...");
    Serial.write ("\n");
    ...
    Serial.write ("\n");
    Serial.write ("=== Benchmark Complete ===");
}
...
{
    // Print CSV header
    Serial.write ("operation iteration payload_size cpu_cycles cpu_time");
    Serial.write ("\n");
    ...
    while (payload_size <= PAYLOAD_MAX) {
        ...
        for (int iter = 1; iter <= ITERATIONS_PER_SIZE; iter++) {
            ...
            Serial.write ("encrypt ");
            Serial.write (iter);
            Serial.write (" ");
            Serial.write (payload_size);
            Serial.write (" ");
            Serial.write (cpu_cycles);
            Serial.write (" ");
            Serial.write (elapsed_us);
            Serial.write (" us\n");
